export const servicesContent = {
    ...
    "skin-care": {
        ...
        detailedSections: [
            ...
            {
                title: "Facials",
                description: "Rejuvenating therapies for every skin need.",
                image: "/images/hero/facial.webp",
                items: [
                    ...
                    { name: "De Stressing Facial", price: "₹1600" },
                    { name: "Preservita Anti Aging", price: "₹3000" },
            ...
            {
                title: "Lotus Ultimo Facials",
                description: "Premium gold, pearl, and platinum treatments.",
                image: "/images/services/hydra_facial_service.webp",
                items: [
            ...
            {
                title: "O3+ Facials",
                description: "Advanced whitening and brightening rituals.",
                image: "/images/services/o3_cleanup_service.webp",
                items: [
    ...
    "pedicure-manicure": {
        ...
        detailedSections: [
            {
                title: "Pedicure",
                description: "Therapeutic care for your feet.",
                image: "/images/services/luxe_pedicure_scene.webp",
                items: [
            ...
            {
                title: "Manicure",
                description: "Therapeutic care for your hands.",
                image: "/images/services/luxe_manicure_scene.webp",
                items: [
    ...
    "body-spa-reflexology": {
        ...
        detailedSections: [
            {
                title: "Body SPA (45min / 60min / 90min)",
                description: "Holistic wellness journeys designed to de-stress the body.",
                ...
                items: [
                    ...
                    { name: "Deep tisue massage", price: "₹1799 / 2499 / 2999" },

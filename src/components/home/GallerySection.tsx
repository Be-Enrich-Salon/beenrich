                    ...
                    >
                        {galleryImages.map((image, index) => (
                            <motion.div
                                ...
                                className="flex-shrink-0 w-full md:w-[600px] lg:w-[700px] relative group cursor-pointer overflow-hidden rounded-2xl shadow-lg snap-center"
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-ink/80 to-transparent p-4">
                                    ...
                                    <p className="text-gold text-xs uppercase tracking-wider">{image.category}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>

                ...
                <div className="grid lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4">
                        ...
                        <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                            <h4 className="text-xl font-bold mb-4 text-white">Commitment to Investors</h4>
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            {aboutContent.investors.pillars.map((pillar, idx) => (
                                <div key={idx} className="bg-stone/5 p-6 rounded-xl hover:bg-stone/10 transition-colors">
                                    <h4 className="text-xl font-bold mb-3 text-gold">{pillar.title}</h4>
                        ...
                        <div>
                            <h3 className="text-2xl font-bold mb-4">Investment Proposition</h3>
